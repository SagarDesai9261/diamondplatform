          ...
          children: [
            ...
            Padding(
              ...
              child: DropdownButtonFormField<String>(
                ...
                hint:  Text(AppLocalizations.of(context)!.translate("select_designation") ?? "Select Designation"),
                onChanged: (newValue) {
                  setState(() {
            ...
            requiretype == false ? Container(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: AppLocalizations.of(context)!.translate("Enter Salary") ??"Enter Salary",
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(20)
                  )
                ),
              ...
              child: TextFormField(
                controller: retail,
                  keyboardType: TextInputType.number,
                decoration: InputDecoration(
                    hintText: AppLocalizations.of(context)!.translate("Enter price per piece") ??"Enter Price per piece",
                    border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(20)
                    )
                ),
          ...
          child: Container(
            ...
            child: Text(
              endJobPostDate != null
                  ...
                  : AppLocalizations.of(context)!.translate("Select End Job Post Date") ??'Select End Job Post Date'.tr(),
